    ...
    unsafe {
      crate::binds::mono_profiler_set_context_loaded_callback(
        ...
        std::mem::transmute::<
          ...
          Option<unsafe extern "C" fn(*mut _MonoProfiler, *mut crate::binds::MonoAppContext)>,
        >(
          Self::context_loaded_callback
            as unsafe extern "C" fn(*mut _Profiler<T>, *mut crate::binds::MonoAppContext),
        ),
      );
  ...
  pub fn add_domain_name_cb(
    ...
    unsafe {
      crate::binds::mono_profiler_set_domain_name_callback(
        self.handle,
        std::mem::transmute::<
          unsafe extern "C" fn(*mut _Profiler<T>, *mut crate::binds::MonoDomain, *const i8),
          Option<
            unsafe extern "C" fn(*mut _MonoProfiler, *mut crate::binds::MonoDomain, *const i8),
          >,
        >(
          Self::domain_name_callback
            as unsafe extern "C" fn(*mut _Profiler<T>, *mut crate::binds::MonoDomain, *const i8),
        ),
      );
